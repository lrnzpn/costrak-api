...
// Using 'any' type assertions is acceptable in tests when mocking complex libraries
...
describe('BudgetController', () => {
  ...
  describe('getAllBudgets', () => {
    it('should get all budgets successfully', async () => {
      ...
      await getAllBudgets(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('getBudgetById', () => {
    it('should get a budget by ID with expenses', async () => {
      ...
      await getBudgetById(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('createBudget', () => {
    it('should create a budget successfully', async () => {
      ...
      await createBudget(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('getBudgetSummary', () => {
    it('should get budget summary successfully', async () => {
      ...
      await getBudgetSummary(mockRequest as Request, mockResponse as Response, mockNext);
